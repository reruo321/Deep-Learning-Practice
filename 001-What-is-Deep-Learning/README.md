...
### Kernel Method
**Kernel Method** is a classification algorithm, and SVM is the most famous thing. A supervised learning method, **SVM(Support Vector Machine)**, tries to make the best decision boundary in the middle of the void, so that it seperates data points into two classes.
